...
const setupGuides = (data) => {
  ...
  if (data.length) {
    ...
    data.forEach(doc => {
      ...
      const li = `
        <li>
          ...
          <a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=${guide.title}&tf=1">REPLY</a>
    ...
    guideList.innerHTML = '<img class="center-align" src="img/bg.jpg" style="width: 1200px;">';
  }
