    ...
    data.forEach(doc => {
      ...
      const li = `
        <li>
          ...
          <a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=${guide.title}&tf=1" class="btn green darken-2 z-depth-0 modal-trigger" target="_blank">REPLY via GMail</a>
